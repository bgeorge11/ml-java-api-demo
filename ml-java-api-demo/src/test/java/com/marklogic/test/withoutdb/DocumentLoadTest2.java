...
public class DocumentLoadTest2 extends AbstractApiTest {
    ...
    public void testLoadXMLDocuments() throws Exception {
    	...
    	String methodName = new DocumentLoadTest2() {}.getClass().getEnclosingMethod().getName();
        ...
        System.out.println(new Date().toString() + " Loaded " + TOTAL_XML_DOCS_ADDED + " documents.");
 
        countOfXMLDocs = deleteDocuments(client, COLLECTION_NAME);
        assertEquals(0, countOfXMLDocs);
        System.out.println(new Date().toString() + " Deleted " + TOTAL_XML_DOCS_ADDED + " documents.");
